...
public class Wood_Stone_Trigger : MonoBehaviour
{
    public static Wood_Stone_Trigger Instance; //Instantiating the Wood_Stone_Trigger.cs
...

    {
        ...
        UIManager.Instance.ShowCurrentStatusHint_Wood_Stone_Trigger();
    }

    public void OnTriggerExit(Collider other) //Leave the range of this object
    {
        couldInteract = false;
        UIManager.Instance.HideCurrentStatusHint_Wood_Stone_Trigger();
    }
}
